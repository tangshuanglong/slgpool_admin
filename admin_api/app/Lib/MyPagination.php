...
class MyPagination {
    ...
    public function __construct($params = array())
    {
        ...
        {
            if (($val = $this->pagination_lang['pagination_'.$key]) !== FALSE)
            {
                $this->$key = $val;
            }
        }
        ...
        CLog::info('info', 'Pagination Class Initialized');
    }
    ...
    public function create_links()
    {
        ...
        if ($this->num_links < 0)
        {
            CLog::error('Your number of links must be a non-negative number.');
        }
        ...
        if ($this->page_query_string === TRUE)
        {
            $this->cur_page = $request->get($this->query_string_segment);
        }
        elseif (empty($this->cur_page))
        {
            ...
            {
                $this->uri_segment = count($request->get());
            }
