...
//        {
//            MyCommon::write_log(__FUNCTION__ . '请求url:' . $uri . ' 接口返回数据： ' .  print_r($params, true), self::$log_path);
//        }
//        self::setCommonHeader($request, $statusCode);
     ...
     * @return array
     */
    public static function returnSuccess(array $data, string $code, string $message): array
    {
