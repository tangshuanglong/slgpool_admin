...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="/admin" class="maincolor">首页</a> <span class="c-999 en">&gt;</span><a href="/banner/pc_index" class="maincolor">首页轮播图片管理</a> <span class="c-999 en">&gt;</span><span class="c-666">PC图片列表</span></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
            <form class="mb-15">
                <div class="row cl">
                    <div class="col-xs-2 col-sm-2">
                        <a href="/banner/pc_add" class="btn btn-success radius">添加轮播图片</a>
                    </div>
                </div>
            </form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/banner/pc_edit/<?php echo $item['id'] ?>" class="btn btn-primary-outline radius">编辑</a>
