...
<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="/admin" class="maincolor">首页</a> <span class="c-999 en">&gt;</span><a href="/banner/app_index" class="maincolor">首页轮播图片管理</a> <span class="c-999 en">&gt;</span><span class="c-666"><?php if ($data['action'] == 'add'): echo '添加APP图片'; ?><?php else: echo '编辑APP图片' ?><?php endif; ?></span></nav>
	<div class="Hui-article">
        ...
        <form action="form.php" class="form form-horizontal" method="post" accept-charset="utf-8">
                ...
                <div class="row cl">
                    <label class="form-label col-xs-3 col-sm-3 col-md-1 col-lg-1">app端图片：</label>
                    <div class="formControls col-xs-3 col-sm-5">
                ...
                <div class="row cl">
                    <label class="form-label col-xs-3 col-sm-3 col-md-1 col-lg-1">app端跳转路径：</label>
                    <div class="formControls col-xs-3 col-sm-5">
                        <input type="text" id="pc_link_href" name="pc_link_href" class="input-text" value="<?php if (isset($data['info']['link_href']) && ! empty($data['info']['link_href'])): echo $data['info']['link_href']; endif; ?>" autocomplete="off" placeholder="app端跳转路径">
                    </div>
                </div>
                 <div class="row cl">
